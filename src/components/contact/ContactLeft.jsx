...
const ContactLeft = () => {
  ...
  return (
    ...
    <p className={`font-k2d ${theme === 'dark' ? 'text-black' : 'text-gray-200 '}`}>I’m always up for a chat. Pop me an email at <span className={`${theme === 'dark' ? 'text-blue-600' : 'text-blue-400'}`}>rahmanadepoju03@gmail.com</span> or give me a shout on social media. </p>
